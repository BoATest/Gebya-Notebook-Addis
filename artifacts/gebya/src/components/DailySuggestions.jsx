...
export default function DailySuggestions({ todayTransactions, onAction }) {
  ...
  return (
    <div
      ...
      style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-md)', boxShadow: 'var(--shadow-xs)' }}
    >
      ...
      <button
        ...
        style={{ background: 'var(--color-primary)', borderRadius: 'var(--radius-sm)', boxShadow: 'var(--shadow-xs)' }}
      >
