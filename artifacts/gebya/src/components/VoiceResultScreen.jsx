    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-white" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 space-y-5">
        ...
        <div className="p-5 rounded-xl text-center" style={{ background: effectiveTotal ? '#f0fdf4' : '#fff7ed', border: `1px solid ${effectiveTotal ? '#bbf7d0' : '#fde68a'}` }}>
          ...
          {effectiveTotal != null && effectiveTotal > 0 ? (
            ...
            <p className="text-base font-semibold font-sans" style={{ color: '#92400e' }}>{t.voiceNoAmount}</p>
          )}
          {hasMultiple && (
      ...
      <div className="px-6 pb-8 pt-2 space-y-3 flex-shrink-0">
        {effectiveTotal != null && effectiveTotal > 0 && isSaleIntent && (
          ...
          >
            <Check className="inline-block w-5 h-5 mr-2 align-[-2px]" />
            {t.voiceSave}
          </button>
        )}
        ...
        >
          <Pencil className="inline-block w-5 h-5 mr-2 align-[-2px]" />
          {t.voiceFix}
        </button>
        ...
        {canAddMore && (
          ...
          >
            <Plus className="inline-block w-4 h-4 mr-2 align-[-1px]" />
        ...
        <div className="flex gap-3">
          ...
          >
            <RotateCcw className="inline-block w-4 h-4 mr-2 align-[-1px]" />
            {t.voiceReRecord}
          </button>
          <button
            ...
            style={{ background: '#f5f5f5', color: '#374151', borderRadius: 'var(--radius-md)' }}
          >
            <Keyboard className="inline-block w-4 h-4 mr-2 align-[-1px]" />
            {t.typeSale}
          </button>
        </div>
      </div>
