export const FREQ_LABELS_EN = { daily: 'Daily', weekly: 'Weekly', monthly: 'Monthly' };
export const FREQ_LABELS_AM = { daily: 'ዕለታዊ', weekly: 'ሳምንታዊ', monthly: 'ወርሃዊ' };

export const PAGE_SIZE = 500;
export const DB_PAGE_SIZE = 500;

export const BUSINESS_TYPE_OPTIONS_EN = [
...
export const BUSINESS_TYPE_OPTIONS_AM = [
