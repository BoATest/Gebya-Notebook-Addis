...
export const DEFAULT_CHANNEL_DEFINITIONS = [
  ...
  { id: 'hellocash',    kind: 'wallet', name: 'HelloCash',    emoji: '🔵', ussd: '*847#' },
  // ─── Banks ──────────────────────────────────────────────────
  { id: 'bank_cbe',         kind: 'bank', name: 'CBE',                emoji: '🏦' },
  { id: 'bank_coop',        kind: 'bank', name: 'Coop Bank',          emoji: '🏦' },
  { id: 'bank_abyssinia',   kind: 'bank', name: 'Abyssinia',          emoji: '🏦' },
  { id: 'bank_awash',       kind: 'bank', name: 'Awash Bank',         emoji: '🏦' },
  { id: 'bank_berhan',      kind: 'bank', name: 'Berhan',             emoji: '🏦' },
  { id: 'bank_buna',        kind: 'bank', name: 'Buna',               emoji: '🏦' },
  { id: 'bank_dashen',      kind: 'bank', name: 'Dashen',             emoji: '🏦' },
  { id: 'bank_dgb',         kind: 'bank', name: 'Debub Global Bank',  emoji: '🏦' },
  { id: 'bank_enat',        kind: 'bank', name: 'Enat Bank',          emoji: '🏦' },
  { id: 'bank_gadaa',       kind: 'bank', name: 'Gadaa Bank',         emoji: '🏦' },
  { id: 'bank_hibret',      kind: 'bank', name: 'Hibret',             emoji: '🏦' },
  { id: 'bank_lion',        kind: 'bank', name: 'Lion',               emoji: '🏦' },
  { id: 'bank_nib',         kind: 'bank', name: 'Nib Bank',          emoji: '🏦' },
  { id: 'bank_ormia',       kind: 'bank', name: 'Oromia',             emoji: '🏦' },
  { id: 'bank_amhara',      kind: 'bank', name: 'Amhara Bank',        emoji: '🏦' },
  { id: 'bank_sidama',      kind: 'bank', name: 'Sidama Bank',       emoji: '🏦' },
  { id: 'bank_tsehay',      kind: 'bank', name: 'Tsehay Bank',       emoji: '🏦' },
  { id: 'bank_united',      kind: 'bank', name: 'United Bank',       emoji: '🏦' },
  { id: 'bank_wegagen',     kind: 'bank', name: 'Wegagen',           emoji: '🏦' },
