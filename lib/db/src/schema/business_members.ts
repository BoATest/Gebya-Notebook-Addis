import { pgTable, serial, integer, varchar, boolean, timestamp, jsonb, text, unique, index } from "drizzle-orm/pg-core";
import { z } from "zod";
...
export const businessMembers = pgTable("business_members", {
  ...
  unique("biz_members_user_business_unique").on(t.userId, t.businessId),   // one user can be in many businesses, but only once per business
